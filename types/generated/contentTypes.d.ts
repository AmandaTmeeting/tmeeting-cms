...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::product.product'
    >;
    market: Schema.Attribute.Enumeration<['SE', 'NO', 'BOTH']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    spotifyEmbedUrl: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiSupportDocumentSupportDocument
  extends Struct.CollectionTypeSchema {
  collectionName: 'support_documents';
  info: {
    displayName: 'Support Document';
    pluralName: 'support-documents';
    singularName: 'support-document';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    docType: Schema.Attribute.Enumeration<['manual', 'download', 'faq']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::support-document.support-document'
    >;
...
export interface ApiSystemStatusSystemStatus extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'system-statuses';
    singularName: 'system-status';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    changelog: Schema.Attribute.Component<'status.changelog-entry', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    incidents: Schema.Attribute.Component<'status.incident', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    systems: Schema.Attribute.Component<'status.system', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
